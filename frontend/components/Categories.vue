  ...
  <div>
    <div class="container my-12 mx-auto px-4 md:px-12 max-w-md mx-auto">
      <div class="flex flex-wrap -mx-7 lg:-mx-4">
        <div class="my-5 px-5 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/2 cursor-pointer" v-for="(category,idx) in Categories" :key="idx">
          <article class="overflow-hidden rounded-lg shadow-lg" @click.prevent="openCatalog(category)">
            ...
            <div class="flex items-center justify-between leading-tight p-4 md:p-4">
              <h1 class="text-lg">
